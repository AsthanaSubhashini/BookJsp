...
public class VisitorsLog implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		System.out.println("on VisitorsLog");
		...
		try
		{
			if(ub.authenticateUser().equals("success"))
			{
				...
				PrintWriter pw = new PrintWriter
						(new FileOutputStream(new File("D:/log.txt"),true));
				pw.println("");
			...
			else
			{
				...
				RequestDispatcher rd = httpRequest.getRequestDispatcher("/WEB-INF/views/index.jsp");
